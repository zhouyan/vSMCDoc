\documentclass[11pt,bib,mint,hyper]{marticle}

\ExplSyntaxOn
\dim_new:N \g_mltxdoc_charwidth_dim
\settowidth{\g_mltxdoc_charwidth_dim}{\texttt{\normalsize 0}}
\geometry{textwidth=80\g_mltxdoc_charwidth_dim}
\ExplSyntaxOff
